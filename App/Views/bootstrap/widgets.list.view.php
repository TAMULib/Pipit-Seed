...
<?php
    foreach ($results as $widget) {
        echo "<tr>
                    ...
                    <td class=\"capitalize\">";
echo '					<a class="btn btn-default do-loadmodal" href="'.$app_http.'?action=parts&widgetid='.$widget->getId().'">Parts</a>
                        <a class="btn btn-default do-loadmodal" href="'.$app_http.'?action=attachments&widgetid='.$widget->getId().'">Attachments</a>
                        <a class="btn btn-default do-loadmodal" href="'.$app_http.'?action=edit&id='.$widget->getId().'">Edit</a>
