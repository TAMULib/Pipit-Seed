...
echo '<form class="do-submit-validate" name="editwidget" method="POST" action="'.$app_http.'">
            ...
            <div class="form-group do-validate">
                ...
                <input class="form-control" type="text" name="widget[name]" value="'.$widget->getName().'" />
            </div>
            <div data-validator="validateNumeric" class="form-group do-validate">
                ...
                <input class="form-control" type="number" name="widget[part_count]" value="'.$widget->getPartCount().'" />
            </div>
            <div class="form-group">
                <label for="widget[description]">Description</label>
                <textarea class="form-control" name="widget[description]">'.$widget->getDescription().'</textarea>
            </div>
